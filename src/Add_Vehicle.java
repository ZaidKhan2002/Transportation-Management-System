...
public class Add_Vehicle extends JFrame {
    ...
    String cm_sitting[] = {"Mini","Prime","XUV"};
    String cm_type[] = {"OPEN","CLOSE"};
    ...
    Add_Vehicle(){
        ...
        btn_add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    if(Add_Vehicle.this.tf_carmodel.getText().equals("") || Add_Vehicle.this.tf_makeyear.getText().equals("") || tf_rent.getText().equals("")){
